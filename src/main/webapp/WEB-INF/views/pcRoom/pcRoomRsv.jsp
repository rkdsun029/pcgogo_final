...
<div id="productTable">
   ...
   <c:forEach var="prd" items="${product }" varStatus="cnt">
      ...
      <tr>
         <td colspan="3"><input type="button" onclick="letRsv()" style="float:left" value="예약하기"></input></td>
      </tr>
   </table>
</div>
</div>
