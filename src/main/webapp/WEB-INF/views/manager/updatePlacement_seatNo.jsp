...
<c:forEach var="p" items="${seatMapList }" varStatus="cnt">
	<input type="hidden" class="hiddenPmContent" value="${p.pmContent_ }"/>
	<input type="hidden" class="hiddenFloorNum" value="${p.floorNum_ }"/>
	<input type="hidden" class="hiddenPmRow" value="${p.pmRow_ }"/>
	<input type="hidden" class="hiddenPmCol" value="${p.pmCol_ }"/>
	<input type="hidden" class="hiddenSeatCount" value="${p.seatCount_ }"/>
